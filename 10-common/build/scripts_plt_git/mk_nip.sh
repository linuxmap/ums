...
nip_platform=(ppc8260 ppc85xx davinci ppc8313 netra powerpc8377)
input_path=$topdir/driver-git/nip
    ...
    cd $input_path/source || exit 1
		...
		rm -rf $input_path/obj/*
 		...
 		case "$1" in
			 ...
			 ;;
			 	netra)
					 make  board=netra clean|| exit 1
					 make  board=netra || exit 1
			 ;;
			 	powerpc8377)
					 make  board=powerpc8377 clean|| exit 1
					 make  board=powerpc8377 || exit 1
			 ;;			 
		esac
...
{	
		case $1 in
			...
			;;
			netra)
					copy_to $output_path/nip/$1/lib${release_name}_snmpagent.a 	.  arm_dm81xx  $2
					copy_to $output_path/nip/$1/lib${release_name}_snmp.a  			.  arm_dm81xx  $2	
					copy_to $output_path/nip/$1/lib${release_name}_nip_api.a 		.  arm_dm81xx  $2
					copy_to $output_path/nip/$1/lib${release_name}_api.a  			.	 arm_dm81xx  $2	
					copy_to $output_path/nip/$1/lib${release_name}_dataswitch.a  			.	 arm_dm81xx  $2	
					copy_to $output_path/nipdebug/$1/\* nipdebug arm_dm81xx  $2	
			;;	
			powerpc8377)
					copy_to $output_path/nip/$1/lib${release_name}_snmpagent.a 	.  ppc_8377_2637  $2
					copy_to $output_path/nip/$1/lib${release_name}_snmp.a  			.  ppc_8377_2637  $2	
					copy_to $output_path/nip/$1/lib${release_name}_nip_api.a 		.  ppc_8377_2637  $2
					copy_to $output_path/nip/$1/lib${release_name}_api.a  			.	 ppc_8377_2637  $2	
					copy_to $output_path/nip/$1/lib${release_name}_dataswitch.a  			.	 ppc_8377_2637  $2	
					copy_to $output_path/nipdebug/$1/\* nipdebug ppc_8377_2637  $2	
			;;					
		esac
}
