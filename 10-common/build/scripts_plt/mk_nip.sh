...
input_path=$topdir/driver-svn/nip
...
{	
   ...
   rm -rf $input_path/obj/*
    ...
    #build nipdebug
    cd $topdir/driver-svn/app/nipdebug
    ...
    if [ "$1" != "ppc8313" ] ; then
       cp -rfd driver-svn/app/nipdebug/obj/$release_name/* $output_path/nipdebug/$1;    
	  else	
       cp -rfd driver-svn/app/nipdebug/obj/ppc_82xx/* $output_path/nipdebug/$1; 
	  fi 	
	  build_tc $1
}
...
build_tc()
{
	cd $topdir/driver-svn/app/iproute2 
