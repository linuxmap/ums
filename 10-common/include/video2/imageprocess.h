...
====================================================================*/
l32 MergePicture(TImageInfo *ptBackgroundImage, TLogoInfo *ptLogo);
...
====================================================================*/
l32  YUV422ToYUV420AndTemporalFilterInit_map(void **ppvHandle, l32 l32SrcWidth, l32 l32SrcHeight, l32 l32SrcStride,
...
2006/04/13	   1.0       邹文艺                   创建
====================================================================*/
l32 YUV422ToYUV420AndTemporalFilterSetParam_map(void *pvHandle, l32 l32SrcWidth, l32 l32SrcHeight, l32 l32SrcStride,
							   l32 l32DstWidth, l32 l32DstHeight, l32 l32DstStride);
...
====================================================================*/
l32 ProduceMosaic420_c(TImageInfo *ptInImage, TImageInfo *ptOutImage, 
					   l32 l32Left, l32 l32Top, l32 l32WindowWidth, l32 l32WindowHeight, l32 l32Granularity);

#define  ProduceMosaic420  ProduceMosaic420_c
/*====================================================================
...
03/07/2006      1.0      赵波                    创建 
====================================================================*/
l32 yuv_to_rgb24_c(u8 *pu8Dst, l32 l32DstStride,TImageInfo *ptInImage);

#define  yuv_to_rgb24	yuv_to_rgb24_c

/*====================================================================
函数名      :	Generate_yuv2rgb_tables
功能	    :	生成yuv420到rgb的查找表
算法实现    :	
引用全局变量:	无
输入参数说明:	无
...
03/07/2006      1.0      赵波                    创建 
====================================================================*/
void Generate_yuv_to_rgb_tables(void);
...
====================================================================*/
l32  YUV422ToYUV420AndTemporalFilterInit_c(void **ppvHandle, l32 l32SrcWidth, l32 l32SrcHeight, l32 l32SrcStride,
						   l32 l32DstWidth, l32 l32DstHeight, l32 l32DstStride);
...
2006/04/21    1.0        ZouWenYi        创建
====================================================================*/
l32 YUV422ToYUV420AndTemporalFilterSetParam_c(void *pvHandle, l32 l32SrcWidth, l32 l32SrcHeight, l32 l32SrcStride,
					   l32 l32DstWidth, l32 l32DstHeight, l32 l32DstStride);
