...
2014/08/15  5.0     肖楚然      兼容unicode编码
=============================================================================*/
...
public:
    ...
    static s8* GetIpStr2(u32 dwIpAddr);
...
//    static void GetLastErrorInfo(CString &csErrorInfo);
    ...
    =============================================================================*/
	static BOOL32 IsValidIpCombineMask(u32 dwIP, u32 dwMask);
	...
	static BOOL32 IsValidCallIP(u32 dwIP, s8* cstrErrStr, u8 byLanType);
