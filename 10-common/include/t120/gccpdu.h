...
class GCC_DiallingString : public PASN_NumericString
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_DiallingString, PASN_NumericString);
#endif
  public:
    GCC_DiallingString(unsigned tag = UniversalNumericString, TagClass tagClass = UniversalTagClass);

    GCC_DiallingString & operator=(const char * v);
    GCC_DiallingString & operator=(const PString & v);
    PObject * Clone() const;
};
...
class GCC_ExtraDiallingString : public PASN_BMPString
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_ExtraDiallingString, PASN_BMPString);
#endif
  public:
    GCC_ExtraDiallingString(unsigned tag = UniversalBMPString, TagClass tagClass = UniversalTagClass);

    GCC_ExtraDiallingString & operator=(const char * v);
    GCC_ExtraDiallingString & operator=(const PString & v);
    GCC_ExtraDiallingString & operator=(const PWORDArray & v);
    GCC_ExtraDiallingString & operator=(const PASN_BMPString & v);
    PObject * Clone() const;
};
...
class GCC_NodeCategory : public PASN_Choice
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_NodeCategory, PASN_Choice);
#endif
  public:
    GCC_NodeCategory(unsigned tag = 0, TagClass tagClass = UniversalTagClass);

    enum Choices {
      e_conventional,
      e_counted,
      e_anonymous,
      e_nonStandardCategory
    };
...
class GCC_ConferenceMode : public PASN_Choice
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_ConferenceMode, PASN_Choice);
#endif
  public:
    GCC_ConferenceMode(unsigned tag = 0, TagClass tagClass = UniversalTagClass);

    enum Choices {
      e_conventional_only,
      e_counted_only,
      e_anonymous_only,
      e_conventional_control,
      e_unrestricted_mode,
      e_non_standard_mode
    };
...
class GCC_MediaList : public PASN_Sequence
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_MediaList, PASN_Sequence);
#endif
  public:
    GCC_MediaList(unsigned tag = UniversalSequence, TagClass tagClass = UniversalTagClass);

    PASN_Boolean m_audio;
    PASN_Boolean m_video;
    PASN_Boolean m_data;
...
class GCC_ChannelAggregationMethod : public PASN_Choice
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_ChannelAggregationMethod, PASN_Choice);
#endif
  public:
    GCC_ChannelAggregationMethod(unsigned tag = 0, TagClass tagClass = UniversalTagClass);
...
class GCC_Profile_simpleProfile;
class GCC_Profile_multimediaProfile;
class GCC_NonStandardParameter;

class GCC_Profile : public PASN_Choice
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_Profile, PASN_Choice);
#endif
  public:
    GCC_Profile(unsigned tag = 0, TagClass tagClass = UniversalTagClass);

    enum Choices {
      e_simpleProfile,
      e_multimediaProfile,
      e_dsmccDownloadProfile,
      e_nonStandard
    };

#if defined(__GNUC__) && __GNUC__ <= 2 && __GNUC_MINOR__ < 9
    operator GCC_Profile_simpleProfile &() const;
#else
    operator GCC_Profile_simpleProfile &();
    operator const GCC_Profile_simpleProfile &() const;
#endif
#if defined(__GNUC__) && __GNUC__ <= 2 && __GNUC_MINOR__ < 9
    operator GCC_Profile_multimediaProfile &() const;
#else
    operator GCC_Profile_multimediaProfile &();
    operator const GCC_Profile_multimediaProfile &() const;
#endif
#if defined(__GNUC__) && __GNUC__ <= 2 && __GNUC_MINOR__ < 9
    operator GCC_NonStandardParameter &() const;
#else
...
class GCC_ExtendedE164NetworkAddress : public PASN_Sequence
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_ExtendedE164NetworkAddress, PASN_Sequence);
#endif
  public:
    GCC_ExtendedE164NetworkAddress(unsigned tag = UniversalSequence, TagClass tagClass = UniversalTagClass);
    ...
    GCC_DiallingString m_internationalNumber;
    GCC_SubAddressString m_subAddress;
    GCC_ExtraDiallingString m_extraDialling;
...
class GCC_TransportAddress : public PASN_Sequence
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_TransportAddress, PASN_Sequence);
#endif
  public:
    GCC_TransportAddress(unsigned tag = UniversalSequence, TagClass tagClass = UniversalTagClass);
...
class GCC_GSTNConnection : public PASN_Sequence
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_GSTNConnection, PASN_Sequence);
#endif
  public:
    GCC_GSTNConnection(unsigned tag = UniversalSequence, TagClass tagClass = UniversalTagClass);

    GCC_ExtendedE164NetworkAddress m_networkAddress;
...
class GCC_GSTNConnection;
class GCC_ISDNConnection;
class GCC_CSDNConnection;
class GCC_PSDNConnection;
class GCC_ATMConnection;
class GCC_ExtendedE164NetworkAddress;
class GCC_TransportAddress;
class GCC_NonStandardParameter;

class GCC_NetworkConnection : public PASN_Choice
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_NetworkConnection, PASN_Choice);
#endif
  public:
    GCC_NetworkConnection(unsigned tag = 0, TagClass tagClass = UniversalTagClass);
    ...
    enum Choices {
      ...
      e_psdnConnection,
      e_atmConnection,
      e_extendedE164NetworkAddress,
      e_transportAddress,
      e_nonStandard
    };

#if defined(__GNUC__) && __GNUC__ <= 2 && __GNUC_MINOR__ < 9
    operator GCC_GSTNConnection &() const;
#else
    operator GCC_GSTNConnection &();
    operator const GCC_GSTNConnection &() const;
#endif
#if defined(__GNUC__) && __GNUC__ <= 2 && __GNUC_MINOR__ < 9
    operator GCC_ISDNConnection &() const;
#else
    operator GCC_ISDNConnection &();
    operator const GCC_ISDNConnection &() const;
#endif
#if defined(__GNUC__) && __GNUC__ <= 2 && __GNUC_MINOR__ < 9
    operator GCC_CSDNConnection &() const;
#else
    operator GCC_CSDNConnection &();
    operator const GCC_CSDNConnection &() const;
#endif
#if defined(__GNUC__) && __GNUC__ <= 2 && __GNUC_MINOR__ < 9
    operator GCC_PSDNConnection &() const;
#else
    operator GCC_PSDNConnection &();
    operator const GCC_PSDNConnection &() const;
#endif
#if defined(__GNUC__) && __GNUC__ <= 2 && __GNUC_MINOR__ < 9
    operator GCC_ATMConnection &() const;
#else
    operator GCC_ATMConnection &();
    operator const GCC_ATMConnection &() const;
#endif
#if defined(__GNUC__) && __GNUC__ <= 2 && __GNUC_MINOR__ < 9
    operator GCC_ExtendedE164NetworkAddress &() const;
#else
    operator GCC_ExtendedE164NetworkAddress &();
    operator const GCC_ExtendedE164NetworkAddress &() const;
#endif
#if defined(__GNUC__) && __GNUC__ <= 2 && __GNUC_MINOR__ < 9
    operator GCC_TransportAddress &() const;
#else
    operator GCC_TransportAddress &();
    operator const GCC_TransportAddress &() const;
#endif
#if defined(__GNUC__) && __GNUC__ <= 2 && __GNUC_MINOR__ < 9
    operator GCC_NonStandardParameter &() const;
#else
...
class GCC_NetworkAddressV2_subtype;

class GCC_NetworkAddressV2 : public PASN_Array
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_NetworkAddressV2, PASN_Array);
#endif
  public:
    GCC_NetworkAddressV2(unsigned tag = UniversalSet, TagClass tagClass = UniversalTagClass);

    PASN_Object * CreateObject() const;
    GCC_NetworkAddressV2_subtype & operator[](PINDEX i) const;
    PObject * Clone() const;
};
...
class GCC_ConferenceDescriptor : public PASN_Sequence
{
  ...
  public:
    ...
    GCC_ConferenceMode m_conferenceMode;
...
class GCC_ConferenceJoinRequest : public PASN_Sequence
{
  ...
  public:
    ...
    GCC_UserData m_userData;
    GCC_NodeCategory m_nodeCategory;
...
class GCC_ConferenceAddRequest : public PASN_Sequence
{
  ...
  public:
    ...
    GCC_UserData m_userData;
    GCC_NodeCategory m_nodeCategory;
    GCC_NetworkAddressV2 m_networkAddressV2;
...
class GCC_Profile_simpleProfile : public PASN_Choice
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_Profile_simpleProfile, PASN_Choice);
#endif
  public:
    GCC_Profile_simpleProfile(unsigned tag = 0, TagClass tagClass = UniversalTagClass);
...
class GCC_ISDNConnection_circuitTypes_subtype;

class GCC_ISDNConnection_circuitTypes : public PASN_Array
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_ISDNConnection_circuitTypes, PASN_Array);
#endif
  public:
    GCC_ISDNConnection_circuitTypes(unsigned tag = UniversalSet, TagClass tagClass = UniversalTagClass);

    PASN_Object * CreateObject() const;
    GCC_ISDNConnection_circuitTypes_subtype & operator[](PINDEX i) const;
    PObject * Clone() const;
};
...
class GCC_ISDNConnection_highLayerCompatibility : public PASN_Sequence
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_ISDNConnection_highLayerCompatibility, PASN_Sequence);
#endif
  public:
    GCC_ISDNConnection_highLayerCompatibility(unsigned tag = UniversalSequence, TagClass tagClass = UniversalTagClass);
...
class GCC_CSDNConnection_circuitTypes_subtype;

class GCC_CSDNConnection_circuitTypes : public PASN_Array
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_CSDNConnection_circuitTypes, PASN_Array);
#endif
  public:
    GCC_CSDNConnection_circuitTypes(unsigned tag = UniversalSet, TagClass tagClass = UniversalTagClass);

    PASN_Object * CreateObject() const;
    GCC_CSDNConnection_circuitTypes_subtype & operator[](PINDEX i) const;
    PObject * Clone() const;
};
...
class GCC_PSDNConnection_networkAddress : public PASN_Choice
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_PSDNConnection_networkAddress, PASN_Choice);
#endif
  public:
    GCC_PSDNConnection_networkAddress(unsigned tag = 0, TagClass tagClass = UniversalTagClass);
...
class GCC_ATMConnection_networkAddress : public PASN_Choice
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_ATMConnection_networkAddress, PASN_Choice);
#endif
  public:
    GCC_ATMConnection_networkAddress(unsigned tag = 0, TagClass tagClass = UniversalTagClass);
...
class GCC_Profile_multimediaProfile_profile : public PASN_Choice
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_Profile_multimediaProfile_profile, PASN_Choice);
#endif
  public:
    GCC_Profile_multimediaProfile_profile(unsigned tag = 0, TagClass tagClass = UniversalTagClass);
...
//
// ISDNConnection_circuitTypes_subtype
//

class GCC_ISDNConnection_circuitTypes_subtype : public PASN_Choice
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_ISDNConnection_circuitTypes_subtype, PASN_Choice);
#endif
  public:
    GCC_ISDNConnection_circuitTypes_subtype(unsigned tag = 0, TagClass tagClass = UniversalTagClass);
...
//
// CSDNConnection_circuitTypes_subtype
//

class GCC_CSDNConnection_circuitTypes_subtype : public PASN_Choice
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_CSDNConnection_circuitTypes_subtype, PASN_Choice);
#endif
  public:
    GCC_CSDNConnection_circuitTypes_subtype(unsigned tag = 0, TagClass tagClass = UniversalTagClass);
...
//
// NetworkAddressV2_subtype_networkConnection
//

class GCC_NetworkConnection;
class GCC_NetworkAddressV2_subtype_networkConnection_aggregatedConnections;

class GCC_NetworkAddressV2_subtype_networkConnection : public PASN_Choice
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_NetworkAddressV2_subtype_networkConnection, PASN_Choice);
#endif
  public:
    GCC_NetworkAddressV2_subtype_networkConnection(unsigned tag = 0, TagClass tagClass = UniversalTagClass);

    enum Choices {
      e_singleConnection,
      e_aggregatedConnections
    };

#if defined(__GNUC__) && __GNUC__ <= 2 && __GNUC_MINOR__ < 9
    operator GCC_NetworkConnection &() const;
#else
    operator GCC_NetworkConnection &();
    operator const GCC_NetworkConnection &() const;
#endif
#if defined(__GNUC__) && __GNUC__ <= 2 && __GNUC_MINOR__ < 9
    operator GCC_NetworkAddressV2_subtype_networkConnection_aggregatedConnections &() const;
#else
    operator GCC_NetworkAddressV2_subtype_networkConnection_aggregatedConnections &();
    operator const GCC_NetworkAddressV2_subtype_networkConnection_aggregatedConnections &() const;
#endif
...
class GCC_ArrayOf_Profile : public PASN_Array
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_ArrayOf_Profile, PASN_Array);
#endif
  public:
    GCC_ArrayOf_Profile(unsigned tag = UniversalSet, TagClass tagClass = UniversalTagClass);

    PASN_Object * CreateObject() const;
    GCC_Profile & operator[](PINDEX i) const;
    PObject * Clone() const;
};
...
class GCC_RosterRefreshRequest_applicationList_applicationKeyList_subtype;

class GCC_RosterRefreshRequest_applicationList_applicationKeyList : public PASN_Array
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_RosterRefreshRequest_applicationList_applicationKeyList, PASN_Array);
#endif
  public:
    GCC_RosterRefreshRequest_applicationList_applicationKeyList(unsigned tag = UniversalSet, TagClass tagClass = UniversalTagClass);

    PASN_Object * CreateObject() const;
    GCC_RosterRefreshRequest_applicationList_applicationKeyList_subtype & operator[](PINDEX i) const;
    PObject * Clone() const;
};
...
class GCC_RosterRefreshRequest_sessionList_sessionKeyList_subtype;

class GCC_RosterRefreshRequest_sessionList_sessionKeyList : public PASN_Array
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_RosterRefreshRequest_sessionList_sessionKeyList, PASN_Array);
#endif
  public:
    GCC_RosterRefreshRequest_sessionList_sessionKeyList(unsigned tag = UniversalSet, TagClass tagClass = UniversalTagClass);

    PASN_Object * CreateObject() const;
    GCC_RosterRefreshRequest_sessionList_sessionKeyList_subtype & operator[](PINDEX i) const;
    PObject * Clone() const;
};
...
//
// RosterRefreshRequest_applicationList_applicationKeyList_subtype
//

class GCC_RosterRefreshRequest_applicationList_applicationKeyList_subtype : public PASN_Sequence
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_RosterRefreshRequest_applicationList_applicationKeyList_subtype, PASN_Sequence);
#endif
  public:
    GCC_RosterRefreshRequest_applicationList_applicationKeyList_subtype(unsigned tag = UniversalSequence, TagClass tagClass = UniversalTagClass);
    ...
    GCC_Key m_applicationProtocolKey;
    GCC_NonStandardParameter m_nonStandardParameter;
...
//
// RosterRefreshRequest_sessionList_sessionKeyList_subtype
//

class GCC_RosterRefreshRequest_sessionList_sessionKeyList_subtype : public PASN_Sequence
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_RosterRefreshRequest_sessionList_sessionKeyList_subtype, PASN_Sequence);
#endif
  public:
    GCC_RosterRefreshRequest_sessionList_sessionKeyList_subtype(unsigned tag = UniversalSequence, TagClass tagClass = UniversalTagClass);
...
//
// NetworkAddressV2_subtype_networkConnection_aggregatedConnections_connectionList
//

class GCC_NetworkAddressV2_subtype_networkConnection_aggregatedConnections_connectionList_subtype;

class GCC_NetworkAddressV2_subtype_networkConnection_aggregatedConnections_connectionList : public PASN_Array
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_NetworkAddressV2_subtype_networkConnection_aggregatedConnections_connectionList, PASN_Array);
#endif
  public:
    GCC_NetworkAddressV2_subtype_networkConnection_aggregatedConnections_connectionList(unsigned tag = UniversalSet, TagClass tagClass = UniversalTagClass);

    PASN_Object * CreateObject() const;
    GCC_NetworkAddressV2_subtype_networkConnection_aggregatedConnections_connectionList_subtype & operator[](PINDEX i) const;
    PObject * Clone() const;
};


//
// ArrayOf_ChannelAggregationMethod
//

class GCC_ChannelAggregationMethod;

class GCC_ArrayOf_ChannelAggregationMethod : public PASN_Array
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_ArrayOf_ChannelAggregationMethod, PASN_Array);
#endif
  public:
    GCC_ArrayOf_ChannelAggregationMethod(unsigned tag = UniversalSet, TagClass tagClass = UniversalTagClass);

    PASN_Object * CreateObject() const;
    GCC_ChannelAggregationMethod & operator[](PINDEX i) const;
    PObject * Clone() const;
};
...
//
// NetworkAddressV2_subtype_networkConnection_aggregatedConnections_connectionList_subtype
//

class GCC_ISDNConnection;
class GCC_CSDNConnection;

class GCC_NetworkAddressV2_subtype_networkConnection_aggregatedConnections_connectionList_subtype : public PASN_Choice
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_NetworkAddressV2_subtype_networkConnection_aggregatedConnections_connectionList_subtype, PASN_Choice);
#endif
  public:
    GCC_NetworkAddressV2_subtype_networkConnection_aggregatedConnections_connectionList_subtype(unsigned tag = 0, TagClass tagClass = UniversalTagClass);
...
class GCC_ISDNConnection : public PASN_Sequence
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_ISDNConnection, PASN_Sequence);
#endif
  public:
    GCC_ISDNConnection(unsigned tag = UniversalSequence, TagClass tagClass = UniversalTagClass);

    enum OptionalFields {
      e_highLayerCompatibility
    };

    GCC_ISDNConnection_circuitTypes m_circuitTypes;
    GCC_ExtendedE164NetworkAddress m_networkAddress;
    GCC_ISDNConnection_highLayerCompatibility m_highLayerCompatibility;
...
class GCC_CSDNConnection : public PASN_Sequence
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_CSDNConnection, PASN_Sequence);
#endif
  public:
    GCC_CSDNConnection(unsigned tag = UniversalSequence, TagClass tagClass = UniversalTagClass);

    GCC_CSDNConnection_circuitTypes m_circuitTypes;
    GCC_ExtendedE164NetworkAddress m_networkAddress;
...
class GCC_PSDNConnection : public PASN_Sequence
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_PSDNConnection, PASN_Sequence);
#endif
  public:
    GCC_PSDNConnection(unsigned tag = UniversalSequence, TagClass tagClass = UniversalTagClass);

    GCC_PSDNConnection_networkAddress m_networkAddress;
...
class GCC_ATMConnection : public PASN_Sequence
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_ATMConnection, PASN_Sequence);
#endif
  public:
    GCC_ATMConnection(unsigned tag = UniversalSequence, TagClass tagClass = UniversalTagClass);

    enum OptionalFields {
      e_maxTransferRate
    };

    GCC_ATMConnection_networkAddress m_networkAddress;
    PASN_Integer m_maxTransferRate;
...
class GCC_Profile_multimediaProfile : public PASN_Sequence
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_Profile_multimediaProfile, PASN_Sequence);
#endif
  public:
    GCC_Profile_multimediaProfile(unsigned tag = UniversalSequence, TagClass tagClass = UniversalTagClass);

    GCC_Profile_multimediaProfile_profile m_profile;
    PASN_Boolean m_t120Data;
...
//
// NetworkAddressV2_subtype
//

class GCC_NetworkAddressV2_subtype : public PASN_Sequence
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_NetworkAddressV2_subtype, PASN_Sequence);
#endif
  public:
    GCC_NetworkAddressV2_subtype(unsigned tag = UniversalSequence, TagClass tagClass = UniversalTagClass);
    ...
    GCC_NetworkAddressV2_subtype_networkConnection m_networkConnection;
    GCC_ArrayOf_Profile m_profiles;
    GCC_MediaList m_mediaConcerned;
...
class GCC_RosterRefreshRequest_applicationList : public PASN_Sequence
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_RosterRefreshRequest_applicationList, PASN_Sequence);
#endif
  public:
    GCC_RosterRefreshRequest_applicationList(unsigned tag = UniversalSequence, TagClass tagClass = UniversalTagClass);

    enum OptionalFields {
      e_nonStandardParameter
    };

    GCC_RosterRefreshRequest_applicationList_applicationKeyList m_applicationKeyList;
    GCC_NonStandardParameter m_nonStandardParameter;
...
class GCC_RosterRefreshRequest_sessionList : public PASN_Sequence
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_RosterRefreshRequest_sessionList, PASN_Sequence);
#endif
  public:
    GCC_RosterRefreshRequest_sessionList(unsigned tag = UniversalSequence, TagClass tagClass = UniversalTagClass);

    enum OptionalFields {
      e_nonStandardParameter
    };

    GCC_RosterRefreshRequest_sessionList_sessionKeyList m_sessionKeyList;
    GCC_NonStandardParameter m_nonStandardParameter;
...
//
// NetworkAddressV2_subtype_networkConnection_aggregatedConnections
//

class GCC_NetworkAddressV2_subtype_networkConnection_aggregatedConnections : public PASN_Sequence
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_NetworkAddressV2_subtype_networkConnection_aggregatedConnections, PASN_Sequence);
#endif
  public:
    GCC_NetworkAddressV2_subtype_networkConnection_aggregatedConnections(unsigned tag = UniversalSequence, TagClass tagClass = UniversalTagClass);

    enum OptionalFields {
      e_aggregationMethods
    };

    GCC_NetworkAddressV2_subtype_networkConnection_aggregatedConnections_connectionList m_connectionList;
    GCC_ArrayOf_ChannelAggregationMethod m_aggregationMethods;
...
class GCC_RosterRefreshRequest : public PASN_Sequence
{
#ifndef PASN_LEANANDMEAN
    PCLASSINFO(GCC_RosterRefreshRequest, PASN_Sequence);
#endif
  public:
    GCC_RosterRefreshRequest(unsigned tag = UniversalSequence, TagClass tagClass = UniversalTagClass);

    enum OptionalFields {
      e_sendConferenceRoster,
      e_applicationList,
      e_sessionList,
      e_nonStandardParameter
    };
    ...
    GCC_NodeCategory m_nodeCategory;
    PASN_Boolean m_fullRefresh;
    PASN_Boolean m_sendConferenceRoster;
    GCC_RosterRefreshRequest_applicationList m_applicationList;
    GCC_RosterRefreshRequest_sessionList m_sessionList;
    GCC_NonStandardParameter m_nonStandardParameter;
