 ...
 * 128 bytes
 */
#define KDVSRTP_MAX_MKI_LEN 128
 ...
 */
#define KDVSRTP_MAX_TRAILER_LEN (KDVSRTP_MAX_TAG_LEN + KDVSRTP_MAX_MKI_LEN)
...
#define KDVSRTP_AES_ICM_128_KEY_LEN_WSALT   (SRTP_SALT_LEN + SRTP_AES_128_KEY_LEN)
#define KDVSRTP_AES_ICM_192_KEY_LEN_WSALT   (SRTP_SALT_LEN + SRTP_AES_192_KEY_LEN)
#define KDVSRTP_AES_ICM_256_KEY_LEN_WSALT   (SRTP_SALT_LEN + SRTP_AES_256_KEY_LEN)

#define KDVSRTP_AES_GCM_128_KEY_LEN_WSALT   (SRTP_AEAD_SALT_LEN + SRTP_AES_128_KEY_LEN)
#define KDVSRTP_AES_GCM_192_KEY_LEN_WSALT   (SRTP_AEAD_SALT_LEN + SRTP_AES_192_KEY_LEN)
#define KDVSRTP_AES_GCM_256_KEY_LEN_WSALT   (SRTP_AEAD_SALT_LEN + SRTP_AES_256_KEY_LEN)

/* backword support */
#define KDVSRTP_AES_128_GCM_KEYSIZE_WSALT KDVSRTP_AES_GCM_128_KEY_LEN_WSALT 
#define KDVSRTP_AES_192_GCM_KEYSIZE_WSALT KDVSRTP_AES_GCM_192_KEY_LEN_WSALT 
#define KDVSRTP_AES_256_GCM_KEYSIZE_WSALT KDVSRTP_AES_GCM_256_KEY_LEN_WSALT 
...
typedef enum {
  ...
  kdvsrtp_err_status_bad_mki      = 25, /**< error MKI present in packet is invalid  */
  kdvsrtp_err_status_pkt_idx_old  = 26, /**< packet index is too old to consider     */
  kdvsrtp_err_status_pkt_idx_adv  = 27, /**< packet index advanced, reset needed      */
 ...
 */
typedef struct kdvsrtp_master_key_t {
  unsigned char *key;
  unsigned char *mki_id;
  unsigned int mki_size;
} kdvsrtp_master_key_t;
...
typedef struct kdvsrtp_policy_t {
  ...
  unsigned char *key;          /**< Pointer to the SRTP master key for
                                *    this stream.                        */
  kdvsrtp_master_key_t **keys;    /** Array of Master Key structures */
...
KDVSRTP_PUBLIC kdvsrtp_err_status_t kdvsrtp_protect_mki(kdvsrtp_ctx_t *ctx, void *rtp_hdr,
...
KDVSRTP_PUBLIC kdvsrtp_err_status_t kdvsrtp_unprotect_mki(kdvsrtp_t ctx, void *srtp_hdr, int *len_ptr,
 ...
 *
 */
KDVSRTP_PUBLIC void kdvsrtp_crypto_policy_set_aes_cm_192_hmac_sha1_80(kdvsrtp_crypto_policy_t *p);
 ...
 *
 */
KDVSRTP_PUBLIC void kdvsrtp_crypto_policy_set_aes_cm_192_hmac_sha1_32(kdvsrtp_crypto_policy_t *p);
 ...
 *
 */
KDVSRTP_PUBLIC void kdvsrtp_crypto_policy_set_aes_cm_192_null_auth(kdvsrtp_crypto_policy_t *p);
...
KDVSRTP_PUBLIC void 
kdvsrtp_crypto_policy_set_sm1_cm_hmac_sm3_80(kdvsrtp_crypto_policy_t *p);

KDVSRTP_PUBLIC void 
kdvsrtp_crypto_policy_set_sm1_cm_hmac_sm3_32(kdvsrtp_crypto_policy_t *p);

KDVSRTP_PUBLIC void 
kdvsrtp_crypto_policy_set_rtcp_sm1_cm_hmac_sm3_80(kdvsrtp_crypto_policy_t *p);

KDVSRTP_PUBLIC void 
kdvsrtp_crypto_policy_set_sm4_cm_hmac_sm3_80(kdvsrtp_crypto_policy_t *p);

KDVSRTP_PUBLIC void 
kdvsrtp_crypto_policy_set_sm4_cm_hmac_sm3_32(kdvsrtp_crypto_policy_t *p);

KDVSRTP_PUBLIC void 
kdvsrtp_crypto_policy_set_rtcp_sm4_cm_hmac_sm3_80(kdvsrtp_crypto_policy_t *p);
...
typedef enum {
  ...
  kdvsrtp_profile_aead_aes_128_gcm   = 7,
  kdvsrtp_profile_aead_aes_256_gcm   = 8,
  kdvsrtp_profile_sm4_cm_sha1_80     = 64,
  kdvsrtp_profile_sm4_cm_sm3_32      = 65,
  kdvsrtp_profile_sm4_cm_sm3_80      = 66,
  kdvsrtp_profile_sm1_cm_sha1_80     = 74,
  kdvsrtp_profile_sm1_cm_sm3_32      = 75,
  kdvsrtp_profile_sm1_cm_sm3_80      = 76
} kdvsrtp_profile_t;
...
KDVSRTP_PUBLIC kdvsrtp_err_status_t
kdvsrtp_protect_rtcp_mki(kdvsrtp_t ctx, void *rtcp_hdr, int *pkt_octet_len,
...
KDVSRTP_PUBLIC kdvsrtp_err_status_t
kdvsrtp_unprotect_rtcp_mki(kdvsrtp_t ctx, void *srtcp_hdr,
                            int *pkt_octet_len,
                            unsigned int use_mki);
 ...
 */
KDVSRTP_PUBLIC kdvsrtp_err_status_t kdvsrtp_set_debug_module(const char *mod_name, int v);
 ...
 */
typedef enum {
    kdvsrtp_log_level_error,   /**< log level is reporting an error message  */
    kdvsrtp_log_level_warning, /**< log level is reporting a warning message */
    kdvsrtp_log_level_info,    /**< log level is reporting an info message   */
    kdvsrtp_log_level_debug    /**< log level is reporting a debug message   */
} kdvsrtp_log_level_t;
 ...
 * libSRTP.
 */
typedef void (kdvsrtp_log_handler_func_t)(kdvsrtp_log_level_t level, const char * msg, void *data);
 ...
 */
KDVSRTP_PUBLIC kdvsrtp_err_status_t kdvsrtp_install_log_handler(kdvsrtp_log_handler_func_t *func, void *data);
 ...
 *
 */
KDVSRTP_PUBLIC kdvsrtp_err_status_t kdvsrtp_get_protect_trailer_length(kdvsrtp_t session, uint32_t use_mki,
 ...
 *
 */
KDVSRTP_PUBLIC kdvsrtp_err_status_t kdvsrtp_get_protect_rtcp_trailer_length(kdvsrtp_t session, uint32_t use_mki,
                                                       uint32_t mki_index, uint32_t *length);
 ...
 *
 */
KDVSRTP_PUBLIC kdvsrtp_err_status_t kdvsrtp_set_stream_roc(kdvsrtp_t session, uint32_t ssrc, uint32_t roc);
 ...
 *
 */
KDVSRTP_PUBLIC kdvsrtp_err_status_t kdvsrtp_get_stream_roc(kdvsrtp_t session, uint32_t ssrc, uint32_t *roc);
...
KDVSRTP_PUBLIC void kdvsrtp_crypto_policy_set_sm4_cm_null_auth(kdvsrtp_crypto_policy_t *p);

KDVSRTP_PUBLIC void kdvsrtp_crypto_policy_set_sm4_cm_hmac_sha1_80(kdvsrtp_crypto_policy_t *p);

KDVSRTP_PUBLIC void kdvsrtp_crypto_policy_set_rtcp_sm4_cm_hmac_sha1_80(kdvsrtp_crypto_policy_t *p);

KDVSRTP_PUBLIC void kdvsrtp_crypto_policy_set_rtcp_sm4_cm_null_auth(kdvsrtp_crypto_policy_t *p);

KDVSRTP_PUBLIC void kdvsrtp_crypto_policy_set_sm1_cm_null_auth(kdvsrtp_crypto_policy_t *p);

KDVSRTP_PUBLIC void kdvsrtp_crypto_policy_set_sm1_cm_hmac_sha1_80(kdvsrtp_crypto_policy_t *p);

KDVSRTP_PUBLIC void kdvsrtp_crypto_policy_set_rtcp_sm1_cm_hmac_sha1_80(kdvsrtp_crypto_policy_t *p);

KDVSRTP_PUBLIC void kdvsrtp_crypto_policy_set_rtcp_sm1_cm_null_auth(kdvsrtp_crypto_policy_t *p);

KDVSRTP_PUBLIC void kdvsrtp_crypto_policy_set_sm1_cm_hmac_sm3_80(kdvsrtp_crypto_policy_t *p);

KDVSRTP_PUBLIC void kdvsrtp_crypto_policy_set_sm1_cm_hmac_sm3_32(kdvsrtp_crypto_policy_t *p);

KDVSRTP_PUBLIC void kdvsrtp_crypto_policy_set_rtcp_sm1_cm_hmac_sm3_32(kdvsrtp_crypto_policy_t *p);

KDVSRTP_PUBLIC void kdvsrtp_crypto_policy_set_rtcp_sm1_cm_hmac_sm3_80(kdvsrtp_crypto_policy_t *p);

KDVSRTP_PUBLIC void kdvsrtp_crypto_policy_set_sm4_cm_hmac_sm3_80(kdvsrtp_crypto_policy_t *p);

KDVSRTP_PUBLIC void kdvsrtp_crypto_policy_set_sm4_cm_hmac_sm3_32(kdvsrtp_crypto_policy_t *p);

KDVSRTP_PUBLIC void kdvsrtp_crypto_policy_set_rtcp_sm4_cm_hmac_sm3_32(kdvsrtp_crypto_policy_t *p);

KDVSRTP_PUBLIC void kdvsrtp_crypto_policy_set_rtcp_sm4_cm_hmac_sm3_80(kdvsrtp_crypto_policy_t *p);


/* for debug info 
 * get git branch and git commit info
 */
KDVSRTP_PUBLIC const char * KdvsrtpGetVersionStr(void);
