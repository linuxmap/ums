...
typedef struct
{
	...
	u32 dwMdate;          /* product manufacture date, such as 20131215 */
	...
	u8 aabyMacAddr[4][6]; /* Eth MAC Address */
	u8 abyUserData[PINFO_USERDATA_LEN + 1]; /* user defined data */
	u8 byMacNum;       /* Eth MAC number */
} TPrdInfo;
