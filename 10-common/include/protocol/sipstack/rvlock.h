...
#define RvLockConstruct(_lg,_l) (*(_l) = RV_OK)
#define RvLockDestruct(_l,_lg) (*(_l) = RV_OK)
#define RvLockGet(_l,_lg) (*(_l) = RV_OK)
#define RvLockRelease(_l,_lg) (*(_l) = RV_OK)
#define RvLockSetAttr(_l,_lg) (*(_l) = RV_OK)
#endif
