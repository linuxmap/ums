...
#define RvSemaphoreConstruct(_c,_lg,_s) (*(_s) = RV_OK)
#define RvSemaphoreDestruct(_s,_lg) (*(_s) = RV_OK)
#define RvSemaphorePost(_s,_lg) (*(_s) = RV_OK)
#define RvSemaphoreWait(_s,_lg) (*(_s) = RV_OK)
#define RvSemaphoreTryWait(_s,_lg) (*(_s) = RV_OK)
#define RvSemaphoreSetAttr(_s,_lg) (*(_s) = RV_OK)
#endif
