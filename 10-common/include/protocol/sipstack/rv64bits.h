...
#ifdef __VXWORKS__
RvUint64 VxUint64Div(RvUint64 val1, RvUint64 val2);
RvInt64 VxInt64Mod(RvInt64 val1, RvInt64 val2);
RvUint64 VxUint64Mod(RvUint64 val1, RvUint64 val2);
RvUint64 VxUint64ShiftRight(RvUint64 val, RvInt numbits);
#endif
