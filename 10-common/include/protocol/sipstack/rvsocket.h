...
/* Changed the definition since ENIP's definition for SOCKET is unsigned int, and 
   there is no reason for it to be unsigned. moreover, we treat RvSocket as signed */
/*typedef SOCKET RvSocket;*/
