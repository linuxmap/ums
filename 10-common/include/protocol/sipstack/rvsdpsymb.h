...
#define RV_SDPSYMB_TCPBFCP		RV_SDPSYMB_VPCI+1
#define RV_SDPSYMB_TCPTLSBFCP		RV_SDPSYMB_TCPBFCP+1
#define RV_SDPSYMB_UDPBFCP		RV_SDPSYMB_TCPTLSBFCP+1
#define RV_SDPSYMB_UDPTLSBFCP		RV_SDPSYMB_UDPBFCP+1
#define RV_SDPSYMB_RTPSAVP	RV_SDPSYMB_UDPTLSBFCP + 1
#define RV_SDPSYMB_MAX_             RV_SDPSYMB_RTPSAVP+1
...
typedef enum {
    ...
    RV_SDPPROTOCOL_TCPBFCP	= RV_SDPSYMB_TCPBFCP,
    RV_SDPPROTOCOL_TCPTLSBFCP	= RV_SDPSYMB_TCPTLSBFCP,
    RV_SDPPROTOCOL_UDPBFCP	= RV_SDPSYMB_UDPBFCP,
    RV_SDPPROTOCOL_UDPTLSBFCP	= RV_SDPSYMB_UDPTLSBFCP,
    RV_SDPPROTOCOL_SRTP	= RV_SDPSYMB_RTPSAVP,
