 ...
 *  RvStatus - the new address structure
 */
RvAddressIpv4 *RvAddressIpv4Construct(
 ...
 *  RvStatus    - the converted ip string.
 */
RVCOREAPI RvChar *RvAddressIpv4GetString(
 ...
 *  RvStatus - the new address structure.
 */
RVCOREAPI RvAddressIpv4 *RvAddressIpv4SetString(
    IN const RvChar *buf,
    INOUT RvAddressIpv4 *addr);
 ...
 *  RvStatus - the new address structure.
 */
RvAddressIpv4 *RvAddressIpv4SetPort(
    INOUT RvAddressIpv4 *addr,
    IN RvUint16 port);
 ...
 *  RvStatus - RV_TRUE if addr is a multicast address.
 */
RvBool RvAddressIpv4IsMulticast(
    IN const RvAddressIpv4 *addr);
 ...
 *  RvStatus - the new address structure
 */
RvAddressIpv6 *RvAddressIpv6Construct(
    IN const RvUint8 *ip,
    IN RvUint16 port,
    IN RvUint32 scopeId,
 ...
 *  RvStatus - the new address structure.
 */
RvAddressIpv6 *RvAddressIpv6SetString(
    IN const RvChar *buf,
    INOUT RvAddressIpv6 *addr);
 ...
 *  RvStatus - the new address structure.
 */
RvAddressIpv6 *RvAddressIpv6SetPort(
    INOUT RvAddressIpv6 *addr,
    IN RvUint16 port);
 ...
 *  RvStatus - the scope value.
 */
RvUint32 RvAddressIpv6GetScope(
    IN const RvAddressIpv6 *addr);
 ...
 *  RvStatus - the new address structure.
 */
RvAddressIpv6 *RvAddressIpv6SetScope(
    INOUT RvAddressIpv6 *addr,
    IN RvUint32 scopeId);
 ...
 *  RvStatus - RV_TRUE if addr is a multicast address.
 */
RvBool RvAddressIpv6IsMulticast(
    IN const RvAddressIpv6 *addr);
