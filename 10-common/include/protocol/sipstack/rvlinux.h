...
#if (RV_OS_VERSION < RV_OS_LINUX_REDHAT_AS)
...
#define RV_SEMAPHORE_ATTRIBUTE_DEFAULT /*SEM_Q_PRIORITY*/0 /* options */

   /* rvmutex: Select mutex interface to use */
#define RV_MUTEX_TYPE RV_MUTEX_POSIX
#define RV_MUTEX_ATTRIBUTE_DEFAULT /*(SEM_Q_PRIORITY | SEM_INVERSION_SAFE)*/0 /* options */
...
#define RV_LOCK_ATTRIBUTE_DEFAULT /*SEM_Q_PRIORITY*/0 /* options */
