 ...
 */
RVCOREAPI
RvStatus RVCALLCONV Rv2TmConvertToTime(
	IN  RvTm	    *tm,
	IN  RvLogMgr*   logMgr,
	OUT RvTime	    *t);
 ...
 */
RVCOREAPI 
RvStatus RVCALLCONV Rv2TmConstructUtc(
	IN  RvTime*     t,
	IN  RvLogMgr*   logMgr,
	OUT RvTm*       tm);
 ...
 */
RVCOREAPI 
RvStatus RVCALLCONV Rv2TmConstructLocal(
	IN  RvTime*     t,
	IN  RvLogMgr*   logMgr,
	OUT RvTm*       tm);
 ...
 */
RVCOREAPI
RvChar * RVCALLCONV Rv2TmAsctime(
	IN  RvTm*       tm,
	IN  RvSize_t	bufsize,
	IN  RvLogMgr*   logMgr,
	OUT RvChar*     buf);
 ...
 */
RVCOREAPI RvSize_t RVCALLCONV Rv2TmStrftime(
	IN  RvTm*       tm, 
	IN  RvChar*     format, 
	IN  RvSize_t	maxsize,
	IN  RvLogMgr*   logMgr,
