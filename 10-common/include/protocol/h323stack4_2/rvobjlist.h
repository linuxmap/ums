 ...
 */
RVCOREAPI 
RvObjList * RVCALLCONV Rv2ObjListConstruct(
    IN void *itemtemp, 
 ...
 */
RVCOREAPI 
RvSize_t RVCALLCONV Rv2ObjListSize(
 ...
 */
RVCOREAPI 
void * RVCALLCONV Rv2ObjListInsertAfter(
    IN RvObjList *objlist, 
    IN void *curitem, 
    OUT void *newitem);
 ...
 */
RVCOREAPI 
void * RVCALLCONV Rv2ObjListInsertBefore(
    IN RvObjList *objlist, 
    IN void *curitem, 
    OUT void *newitem);
 ...
 */
RVCOREAPI 
void * RVCALLCONV Rv2ObjListGetNext(
    IN RvObjList *objlist, 
    IN void *curitem, 
 ...
 */
RVCOREAPI 
void * RVCALLCONV Rv2ObjListGetPrevious(
    IN RvObjList *objlist, 
    IN void *curitem, 
    IN RvBool removeitem);
 ...
 */
RVCOREAPI 
void * RVCALLCONV Rv2ObjListRemoveItem(
    IN RvObjList *objlist, 
    IN void *item);
