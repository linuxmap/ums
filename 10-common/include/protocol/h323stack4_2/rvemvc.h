/***********************************************************************
Filename   : rvmsvcce.h
Description: config file Microsoft Visual C CE compiler tools
************************************************************************
...
#pragma warning (disable : 4310) /* cast truncates constant value (level 3) */
#pragma warning (disable : 4127) /* conditional expression is constant (level 4) */
#pragma warning (disable : 4206) /* nonstandard extension used : translation unit is empty (level 4) */
