...
/* QOS support - relevant only for Windows */
#if (RV_OS_TYPE == RV_OS_TYPE_WIN32)
#if defined(RV_CFLAG_QOS)
#undef  RV_QOS_TYPE
#define RV_QOS_TYPE RV_QOS_WSA
#endif
#endif
...
#if defined(RV_CFLAG_EPOLL)
#undef  RV_SELECT_TYPE
#define RV_SELECT_TYPE RV_SELECT_EPOLL
#endif
//////////////////////////////////////////////////////////////////////////
