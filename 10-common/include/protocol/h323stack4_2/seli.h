 ...
 *	add by Tan guang
 */
RVAPI void RVCALLCONV seliSetMultiThreads(int mt);

RVAPI int RVCALLCONV RadInitSem();
RVAPI int RVCALLCONV RadEnterCritic();
RVAPI int RVCALLCONV RadExitCritic();
RVAPI int RVCALLCONV RadEndSem();
//end
