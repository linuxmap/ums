 ...
 */
RVCOREAPI 
RvObjPool * RVCALLCONV Rv2ObjPoolConstruct( 
    IN void *itemtemp, 
 ...
 */
RVCOREAPI 
RvBool RVCALLCONV Rv2ObjPoolDestruct(
 ...
 */
RVCOREAPI 
RvSize_t RVCALLCONV Rv2ObjPoolTotalItems(
    IN RvObjPool *objpool);
 ...
 */
RVCOREAPI 
RvSize_t RVCALLCONV Rv2ObjPoolFreeItems(
    IN RvObjPool *objpool);
 ...
 */
RVCOREAPI 
RvSize_t RVCALLCONV Rv2ObjPoolTotalPages(
    IN RvObjPool *objpool);
 ...
 */
RVCOREAPI 
RvSize_t RVCALLCONV Rv2ObjPoolItemsPerPage(
    IN RvObjPool *objpool);
 ...
 */
RVCOREAPI 
RvSize_t RVCALLCONV Rv2ObjPoolItemBlockSize(
    IN RvObjPool *objpool);
 ...
 */
RVCOREAPI 
RvSize_t RVCALLCONV Rv2ObjPoolPageSize(
    IN RvObjPool *objpool);
 ...
 */
RVCOREAPI 
RvSize_t RVCALLCONV Rv2ObjPoolGetMaxitems(
    IN RvObjPool *objpool);
 ...
 */
RVCOREAPI 
RvBool RVCALLCONV Rv2ObjPoolSetMaxitems(
    IN RvObjPool *objpool, 
    IN RvSize_t newmax);
 ...
 */
RVCOREAPI 
RvSize_t RVCALLCONV Rv2ObjPoolGetMinitems(
    IN RvObjPool *objpool);
 ...
 */
RVCOREAPI 
RvBool RVCALLCONV Rv2ObjPoolSetMinitems(
    IN RvObjPool *objpool, 
    IN RvSize_t newmin);
 ...
 */
RVCOREAPI 
RvSize_t RVCALLCONV Rv2ObjPoolGetFreelevel(
    IN RvObjPool *objpool);
 ...
 */
RVCOREAPI 
RvBool RVCALLCONV Rv2ObjPoolSetFreelevel(
    IN RvObjPool *objpool, 
 ...
 */
RVCOREAPI 
RvSize_t RVCALLCONV Rv2ObjPoolAddItems(
    IN RvObjPool *objpool, 
 ...
 */
RVCOREAPI 
RvSize_t RVCALLCONV Rv2ObjPoolAddPages(
    IN RvObjPool *objpool, 
 ...
 */
RVCOREAPI 
RvSize_t RVCALLCONV Rv2ObjPoolSalvage(
    IN RvObjPool *objpool);
 ...
 */
RVCOREAPI 
void * RVCALLCONV Rv2ObjPoolGetItem(
    IN RvObjPool *objpool);
 ...
 */
RVCOREAPI 
RvBool RVCALLCONV Rv2ObjPoolReleaseItem(
    IN RvObjPool *objpool, 
    IN void *item);
