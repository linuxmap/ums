 ...
 */
RvStatus Rv2QueueSourceConstruct(IN RvLogMgr	*logMgr);
 ...
 */
RVCOREAPI 
RvStatus RVCALLCONV Rv2QueueConstruct(
 ...
 */
RVCOREAPI 
RvStatus RVCALLCONV Rv2QueueDestruct(
	IN RvQueue *queue);
 ...
 */
RVCOREAPI RvStatus RVCALLCONV Rv2QueueReceive(
	IN  RvQueue		*queue, 
	IN  RvBool		wait,
 ...
 */
RVCOREAPI 
RvStatus RVCALLCONV Rv2QueueSend(
	IN  RvQueue		*queue, 
	IN  void		*buf, 
	IN  RvSize_t	bufsize,
	IN  RvInt		priority, 
 ...
 */
RVCOREAPI
RvStatus RVCALLCONV Rv2QueueStop(
	IN RvQueue *queue);
 ...
 * RETURN  : RV_OK if successful otherwise an error code.
 */
RVCOREAPI RvStatus RVCALLCONV Rv2QueueClear(
	IN RvQueue *queue);
 ...
 */
RVCOREAPI RvBool RVCALLCONV Rv2QueueIsStopped(
	IN RvQueue *queue);
 ...
 */
RVCOREAPI RvSize_t RVCALLCONV Rv2QueueSize(
	IN RvQueue *queue);
 ...
 */
RVCOREAPI RvSize_t RVCALLCONV Rv2QueueItems(
	IN RvQueue *queue);
