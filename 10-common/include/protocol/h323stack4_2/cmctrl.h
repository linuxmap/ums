...
/*
Jacky Wei: We'll use MSD to exchange Quantum Key of Streaming Data,
	This key info will be generated by Master.
*/
RVAPI int RVCALLCONV
cmCallMasterSlaveDetermineResponseEx(
									 IN   HCALL      hsCall,
									 IN   int        isMaster,
									 IN const RvChar *pchQuantumKey,
									 IN   int		 nKeySize/* in bytes */
									 );
#endif
