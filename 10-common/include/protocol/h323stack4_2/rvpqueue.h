 ...
 */
RVCOREAPI 
RvPQueue * RVCALLCONV Rv2PQueueConstruct(
    IN RvInt qtype, 
 ...
 */
RVCOREAPI 
void RVCALLCONV Rv2PQueueDestruct(
    IN RvPQueue *pqueue);
 ...
 */
RVCOREAPI 
RvSize_t RVCALLCONV Rv2PQueueNumItems(
    IN RvPQueue *pqueue);
 ...
 */
RVCOREAPI 
RvSize_t RVCALLCONV Rv2PQueueSize(
    IN RvPQueue *pqueue);
 ...
 */
RVCOREAPI 
RvSize_t RVCALLCONV Rv2PQueueChangeSize(
    IN RvPQueue *pqueue, 
    IN RvSize_t newsize);
 ...
 */
RVCOREAPI 
void RVCALLCONV Rv2PQueueClear(
    IN RvPQueue *pqueue);
 ...
 */
RVCOREAPI 
void * RVCALLCONV Rv2PQueueRemove(
    IN RvPQueue *pqueue, 
