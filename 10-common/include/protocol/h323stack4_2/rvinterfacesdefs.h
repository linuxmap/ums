...
/* RV_QOS_TYPE - specifies if QOS in Windows is supported */
#define RV_QOS_NONE 0
#define RV_QOS_WSA  1
...
#define RV_LOGLISTENER_NONE 3              /* Support none of the sample listeners */
