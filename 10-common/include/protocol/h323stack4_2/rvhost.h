...
RvStatus Rv2HostInit(void);
RvStatus Rv2HostEnd(void);
RvStatus Rv2HostSourceConstruct(IN RvLogMgr* logMgr);
 ...
 */
RVCOREAPI RvStatus RVCALLCONV Rv2HostGetIpList(
    IN      RvChar*     hostName,
	IN      RvLogMgr*   logMgr,
 ...
 *           Other values on failure
 */
RVCOREAPI RvStatus RVCALLCONV Rv2HostLocalGetName(
 ...
 *           Other values on failure
 */
RVCOREAPI RvStatus RVCALLCONV Rv2HostLocalGetAddress(
	IN      RvLogMgr*   logMgr,
 ...
 */
RVCOREAPI
RvStatus RVCALLCONV Rv2HostMopiSetIpAddress(RvChar *address);
#endif
