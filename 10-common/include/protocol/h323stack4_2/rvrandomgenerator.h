...
Rv2RandomGeneratorConstruct(IN RvRandomGenerator* r, IN RvRandom seed);
 ...
 */
RVCOREAPI RvStatus RVCALLCONV
Rv2RandomGeneratorGetValue(IN RvRandomGenerator* r, OUT RvRandom* value);
 ...
 */
RVCOREAPI RvStatus RVCALLCONV
Rv2RandomGeneratorGetInRange(RvRandomGenerator* r, RvRandom n, OUT RvRandom* value);
