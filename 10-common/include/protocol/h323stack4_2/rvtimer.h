 ...
 * RETURN  : RV_OK if successful otherwise an error code. 
 */
RvStatus Rv2TimerSourceConstruct(
	IN RvLogMgr	*logMgr);
 ...
 */
RVCOREAPI 
RvStatus RVCALLCONV Rv2TimerQueueConstruct( 
	IN  RvInt			tqtype, 
 ...
 */
RVCOREAPI
RvStatus RVCALLCONV Rv2TimerQueueControl(
 ...
 */
RVCOREAPI
RvStatus RVCALLCONV Rv2TimerQueueSetLogMgr(
    IN RvTimerQueue     *tqueue,
    IN  RvLogMgr        *logMgr);
 ...
 */
RVCOREAPI
RvSize_t RVCALLCONV Rv2TimerQueueNumEvents(
	IN RvTimerQueue *tqueue);
 ...
 */
RVCOREAPI 
RvSize_t RVCALLCONV Rv2TimerQueueGetSize(
	IN RvTimerQueue *tqueue);
 ...
 */
RVCOREAPI
RvSize_t RVCALLCONV Rv2TimerQueueSetSize(
	IN RvTimerQueue *tqueue, 
	IN RvSize_t		newsize);
 ...
 */
RVCOREAPI 
RvSize_t RVCALLCONV Rv2TimerQueueAddSize(
	IN RvTimerQueue *tqueue, 
	IN RvSize_t		addsize);
 ...
 */
RVCOREAPI
RvSize_t RVCALLCONV Rv2TimerQueueGetMaxtimers(
	IN RvTimerQueue *tqueue);
 ...
 */
RVCOREAPI
RvBool RVCALLCONV Rv2TimerQueueSetMaxtimers(
	IN RvTimerQueue *tqueue, 
	IN RvSize_t		maxtimers);
 ...
 */
RVCOREAPI
RvBool RVCALLCONV Rv2TimerQueueChangeMaxtimers(
	IN RvTimerQueue *tqueue, 
	IN RvSize_t		delta, 
	IN RvBool		direction);
 ...
 */
RVCOREAPI
RvSize_t RVCALLCONV Rv2TimerQueueGetMintimers(
	IN RvTimerQueue *tqueue);
 ...
 */
RVCOREAPI
RvBool RVCALLCONV Rv2TimerQueueSetMintimers(
	IN RvTimerQueue *tqueue, 
	IN RvSize_t		mintimers);
 ...
 */
RVCOREAPI
RvBool RVCALLCONV Rv2TimerQueueChangeMintimers(
	IN RvTimerQueue *tqueue, 
	IN RvSize_t		delta, 
	IN RvBool		direction);
 ...
 */
RVCOREAPI
RvSize_t RVCALLCONV Rv2TimerQueueGetFreelevel(
	IN RvTimerQueue *tqueue);
 ...
 */
RVCOREAPI
RvBool RVCALLCONV Rv2TimerQueueSetFreelevel(
	IN RvTimerQueue *tqueue, 
	IN RvSize_t		freelevel);
 ...
 */
RVCOREAPI 
RvStatus RVCALLCONV Rv2TimerQueueNextEvent(
	IN  RvTimerQueue	*tqueue, 
 ...
 */
RVCOREAPI 
RvStatus RVCALLCONV Rv2TimerQueueDestruct(
	IN RvTimerQueue *tqueue);
 ...
 */
RVCOREAPI 
RvStatus RVCALLCONV Rv2TimerStart(
	IN RvTimer		*timer, 
	IN RvTimerQueue	*tqueue, 
	IN RvInt		timertype, 
	IN RvInt64		delay, 
	IN RvTimerFunc	callback,
	IN void			*userdata);
 ...
 */
RVCOREAPI 
RvStatus RVCALLCONV Rv2TimerCancel(
	IN RvTimer					*timer,
 ...
 */
RVCOREAPI
RvStatus RVCALLCONV Rv2TimerGetRemainingTime(
    IN  RvTimer     *timer,
    OUT RvInt64     *delay);
 ...
 */
RVCOREAPI
RvInt64 RVCALLCONV Rv2TimerResolution(
	RvLogMgr *logMgr);
 ...
 */
RVCOREAPI RvStatus RVCALLCONV Rv2TimerQueueService(
	IN RvTimerQueue *tqueue, 
