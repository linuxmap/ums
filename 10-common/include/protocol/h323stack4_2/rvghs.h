/***********************************************************************
Filename   : rvghs.h
Description: config file Greenhills compiler tools
************************************************************************
...
#pragma ghs nowarning 174 /* for ignoring the "expression has no effect" warnings... */
#pragma ghs nowarning 111 /* for ignoring the "statement is unreachable" warnings... */
