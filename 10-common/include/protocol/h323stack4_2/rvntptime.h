 ...
 */
RVCOREAPI 
RvNtpTime * RVCALLCONV Rv2NtpTimeConstruct(
    IN RvUint32 secs, 
 ...
 */
RVCOREAPI 
RvNtpTime * RVCALLCONV Rv2NtpTimeConstructFromTime(
    IN const RvTime *t, 
    IN RvBool timetype,
    OUT RvNtpTime *ntime);
 ...
 */
RVCOREAPI 
RvNtpTime * RVCALLCONV Rv2NtpTimeConstructFrom64(
    IN RvUint64 ntime, 
    IN RvUint8 decimal,
 ...
 */
RVCOREAPI 
RvNtpTime * RVCALLCONV Rv2NtpTimeChop(
 ...
 */
RVCOREAPI 
RvNtpTime * RVCALLCONV Rv2NtpTimeSubtract(
 ...
 */
RVCOREAPI 
RvNtpTime * RVCALLCONV Rv2NtpTimeAdd(
    IN const RvNtpTime *newtime, 
    IN const RvNtpTime *oldtime,
    OUT RvNtpTime *result);
 ...
 */
RVCOREAPI 
RvTime * RVCALLCONV Rv2NtpTimeToTime(
    OUT RvTime *t, 
    IN  RvBool timetype,
    IN  const RvNtpTime *ntime);
 ...
 */
RVCOREAPI 
RvUint64 RVCALLCONV Rv2NtpTimeTo64(
    IN const RvNtpTime *ntime, 
    IN RvUint8 secbits, 
    IN RvUint8 fracbits);
 ...
 */
RVCOREAPI 
RvUint32 RVCALLCONV Rv2NtpTimeNsecsToFraction(
    IN RvInt32 nsecs);
 ...
 */
RVCOREAPI 
RvInt32 RVCALLCONV Rv2NtpTimeFractionToNsecs(
    IN RvUint32 fraction);
