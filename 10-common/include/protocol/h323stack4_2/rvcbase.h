 ...
 */
RVCOREAPI RvStatus RVCALLCONV Rv2CBaseInit(void);

/********************************************************************************************
 * RvCBaseEnd - common core shutdown function
 * Must be called before system exit to clean up. It is not reentrant so 
 * simultaneous calls to it (and Rv2CBaseInit) MUST NOT be made.
 * Not thread-safe function
 * INPUT   : none
 * OUTPUT  : none
 * RETURN  : RV_OK or appropriate error code
 */
RVCOREAPI RvStatus RVCALLCONV Rv2CBaseEnd(void);
