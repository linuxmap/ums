...
//[20120613]
    ...
    h_ctrl_nonstandardVrsDef,           /***************<<非标自定义》******************
						                 ...
						                 */
//[20140704]
	h_ctrl_StartMtVmpReq,		/********** <<终端开启画面合成请求>>*************************
   								 * ter -->Mcu
   								 * [消息体]
	...
	h_ctrl_StartMtVmpRsp,		/***********<<停止终端画面合成请求>>**************************          
								 * ter --> Mcu  
								 * [消息体]
								 * u8(画面合成类型：vccommon.h中定义)
								 */

	h_ctrl_StartMtVmpNotify,		/************<<终端开启画面合成通告>>***************************
   									 * Mcu -->ter
   									 * [消息体]
   									 * u8(0-成功 1-失败)
									 * u8(画面合成类型：vccommon.h中定义)
	...
	h_ctrl_StopMtVmpReq, 		/************<<停止终端画面合成请求>>***************************          
								 * ter --> Mcu  
								 * [消息体]
								 * u8(画面合成类型：vccommon.h中定义)
								 */

	h_ctrl_StopMtVmpRsp,		/************<<停止终端画面合成请求应答>>***************************          
								 * Mcu --> ter 
								 * [消息体]
								 * u8(0-成功 1-失败)
								 * u8(画面合成类型：vccommon.h中定义) */

	h_ctrl_StopMtVmpNotify,   		/************<<停止终端画面合成请求应答>>***************************          
									 * Mcu --> ter 
									 * [消息体]
									 * u8(0-成功 1-失败)
									 * u8(画面合成类型：vccommon.h中定义) 
	...
	h_ctrl_ChangeMtVmpReq,		/************<<更改终端画面合成请求>>***************************
 								 * ter -->Mcu
 								 * [消息体]
								 * u8(画面合成类型：vccommon.h中定义)
								 * u8(画面合成方式：vccommon.h中定义)
	...
	h_ctrl_ChangeMtVmpRsp, 		/************<<更改终端自主画面合成请求应答>>***************************
 								 * Mcu -->ter
 								 * [消息体]
								 * u8(0-成功 1-失败)
								 * u8(画面合成类型：vccommon.h中定义)
	...
	h_ctrl_ChangeMtVmpNotify,		/************<<更改终端画面合成通告>>***************************
 									 * Mcu -->ter
 									 * [消息体]
									 * u8(0-成功 1-失败)
									 * u8(画面合成类型：vccommon.h中定义)
