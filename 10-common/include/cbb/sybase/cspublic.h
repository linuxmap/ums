...
#define CS_OPT_IDENTITYUPD_ON	(CS_INT)5039	/* turn on identity update */
#define CS_OPT_IDENTITYUPD_OFF	(CS_INT)5040	/* turn off identity update */
...
#define CS_MAX_OPTION           CS_OPT_HIDE_VCC
...
#define CS_MAX_REQ_CAP		CS_REQ_CURINFO3
...
#define CS_DATA_NOZEROLEN	(CS_INT)38
