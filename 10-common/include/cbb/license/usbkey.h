...
#define IOprKey_GetErrorDescription(This,wErrorCode,pVal)	\
    (This)->lpVtbl -> GetErrorDescription(This,wErrorCode,pVal)
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE IOprKey_GetErrorDescription_Proxy( 
    IOprKey __RPC_FAR * This,
    /* [in] */ unsigned short wErrorCode,
    /* [retval][out] */ BSTR __RPC_FAR *pVal);


void __RPC_STUB IOprKey_GetErrorDescription_Stub(
    IRpcStubBuffer *This,
...
#ifndef __USBKEYLib_LIBRARY_DEFINED__
#define __USBKEYLib_LIBRARY_DEFINED__

/* library USBKEYLib */
/* [helpstring][version][uuid] */ 


EXTERN_C const IID LIBID_USBKEYLib;

EXTERN_C const CLSID CLSID_OprKey;

#ifdef __cplusplus

class DECLSPEC_UUID("E8F57E98-D4EE-497B-B819-95203A4825A8")
OprKey;
#endif
#endif /* __USBKEYLib_LIBRARY_DEFINED__ */
