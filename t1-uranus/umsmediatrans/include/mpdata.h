...
extern SEMHANDLE g_semUpdateIframeInfo;
#define ENTER_UPDATESEM OspSemTake(g_semUpdateIframeInfo);
#define EXIT_UPDATESEM OspSemGive(g_semUpdateIframeInfo);
...
public:
	static CPortVector	m_tRcvCheck;
	static CPortVector	m_tSndCheck;
private:
