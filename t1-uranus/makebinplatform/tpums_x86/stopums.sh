...
############
#stop httpd
process_stop_txt="/usr/apache/"
process_pid=$(check_process_alive $process_stop_txt)
[ "x$process_pid" != "x0" ] && /usr/apache/bin/apachectl stop && echo "/usr/apache/bin/apachectl stop"
...
############
#stop logserver
process_stop_txt="$ums_path/log4cplusserver.linux"
check_and_kill_process $process_stop_txt
